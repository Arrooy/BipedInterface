...
/**
 * Part de la vista dedicada a la creacio del JFrame LSFinder
 */
...
public class FinderWindow extends JFrame {
    ...
    /** Boto per carregar l'arxiu seleccionat a LSParser*/
    ...
    public FinderWindow(){
        ...
        setTitle("Bot_AnimationFinder " + Main.VERSION);
        setResizable(false);
        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
    }

    /**
     * configController serveix per a establir el controlador per a cada component de la UI d'LSFinder.
    ...
    public void configController(ActionListener controlador){
        ...
        // Indicant el mateix acttionCommand, facilitará la sincronitzacio dels RadioButtons al controlador.
